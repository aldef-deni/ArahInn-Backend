...
<body>
  ...
  <table class="items">
    <thead>
      <tr>
        ...
        <th>Deskripsi</th>
        <th class="r" style="width:24%;">Jumlah Total</th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        <td>{{ $i + 1 }}</td>
        <td>{{ $it['product'] }}</td>
        <td><div class="desc-main">{{ $it['desc'] }}</div><div class="desc-sub">{{ $it['sub'] }}</div></td>
  ...
  <table class="totals">
    ...
    <tr><td>Biaya Layanan</td><td class="r">Sudah termasuk</td></tr>
